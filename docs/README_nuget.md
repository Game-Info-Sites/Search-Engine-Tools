...
[![GitHub license](https://img.shields.io/github/license/Game-Info-Sites/Search-Engine-Tools?color=8AB803)](https://github.com/Game-Info-Sites/Search-Engine-Tools/blob/main/LICENSE)
...
Developers are able to pick and choose which tools and properties they want to use.