...
namespace SearchEngineTools.Repositories
{
    ...
    public interface ISearchEngineSubmissionQueueRepository
    {
        ...
        /// <param name="maxRetryCount">The maximum number of retry attempts for each submission.</param>
        ...
        /// pending.</returns>
        public Task<IReadOnlyList<SearchEngineSubmissionItem>> GetPendingAsync(int maxItems, int maxRetryCount, CancellationToken cancellation = default);
